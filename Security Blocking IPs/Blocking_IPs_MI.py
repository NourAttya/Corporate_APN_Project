def Blocking_IPs_MI (BlockingIP):
    ...
    script.write('HQ-GI: \n')
    script.write(
        'delete security zones security-zone Internet address-book address Suspected_' + BlockingIP + ' ' + BlockingIP + '\n')
    script.write(
        'delete security zones security-zone Internet address-book address-set Suspected_IPs_1 address Suspected_' + BlockingIP + '\n')
    script.write('--------------------------------------------------------------------------------- \n \n')
